...
for j in range(agemin, agemax+1): 
    arg = 0
    ...
    np.savetxt("photoz_" + str(agemin) + "_" + str(agemax) + ".txt", output, header="obj_no spec_z phot_z age tau EBV norm chi")
